...
; Entry context save of selected registers
	 ...
	 ;PUSH  DSRPAG            ; save context of PSVPAG
         PUSH  INTCON1           ; save context of INTCON1

         MOV   INTCON1, w8       ; This algorithm will cause accumulator overflow
         MOV   #0xF9FF, w10      ; while running. Only leave the catastrophic
         AND   w10, w8, w8       ; overflow enabled (if it was previously)
         MOV   w8, INTCON1
...
; Cleanup(Context restore of selected registers)
         ...
         NOP
         POP  INTCON1               ; restore context of INTCON1
