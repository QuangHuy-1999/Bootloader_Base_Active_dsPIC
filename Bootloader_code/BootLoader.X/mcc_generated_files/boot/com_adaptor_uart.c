...
uint16_t BOOT_COM_GetBytesReady()
{
    ...
    while ( UART2_IsRxReady() && (uartComData.pendingCommandLength < BOOT_CONFIG_MAX_PACKET_SIZE) )
    {
        uartComData.pendingCommand[uartComData.pendingCommandLength++]= UART2_Read();
